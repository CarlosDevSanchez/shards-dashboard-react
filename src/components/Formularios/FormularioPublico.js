            ...
            <form onSubmit={this.handlerSubmit}>
                ...
                <div className="form-row">
                    <div className="form-group col-md-5">
                        ...
                        <input type="text" name="name" className="form-control" style={{background: 'transparent', borderColor: 'gray'}} onChange={this.handlerChange} id="inputName" value={name} placeholder="Nombre"/>
                    </div>
                    <div className="form-group col-md-3">
                        <label for="inputYears" style={{color: 'gray'}}>Edad Anunciante</label>
                        <input type="text" name="age" className="form-control" style={{background: 'transparent', borderColor: 'gray'}} onChange={this.handlerChange} id="inputYears" value={age} placeholder="Edad"/>
                    </div>
                    <div className="form-group col-md-4">
                        <label for="inputFhone" style={{color: 'gray'}}>Telefono</label>
                        <input type="text" name="phone" className="form-control" style={{background: 'transparent', borderColor: 'gray'}} onChange={this.handlerChange} id="inputphone" value={phone} placeholder="Numero telefonico"/>
                    </div>
                    
                    <div className="form-group col-md-4">
                        <label for="inputFhone" style={{color: 'gray'}}>Whatsapp</label>
                        <input type="text" name="phoneW" className="form-control" style={{background: 'transparent', borderColor: 'gray'}} onChange={this.handlerChange} id="inputphone" value={phoneW} placeholder="Numero Whatsapp"/>
                    </div>
                    <div className="form-group col-md-4">
                        <label for="inputLastName" style={{color: 'gray'}}>Instagram</label>
                        <input type="text" name="linkInstagram" className="form-control" style={{background: 'transparent', borderColor: 'gray'}} onChange={this.handlerChange} id="inputLastName" value={linkInstagram} placeholder="Link Instagram"/>
                    </div>
                    <div className="form-group col-md-4">
                        <label for="inputLastName" style={{color: 'gray'}}>Twitter</label>
                        <input type="text" name="linkTwitter" className="form-control" style={{background: 'transparent', borderColor: 'gray'}} onChange={this.handlerChange} id="inputLastName" value={linkTwitter} placeholder="Link Twitter"/>
                    </div>
                </div>
                ...
                <section className="container form-inline" >
                    <div className="form-check mr-1">
                        <input className="form-check-input" type="checkbox" name="dpropio" onChange={this.handlerChangeCheckBox} value={dpropio} checked={dpropio ? true : false} id="defaultCheck1"/>
                        <label className="form-check-label" style={{color: 'gray'}}>
                            Dpto Propio
                        </label>
                    </div>
                    <div className="form-check mx-1">
                        <input className="form-check-input" type="checkbox" name="hotel" onChange={this.handlerChangeCheckBox} value={hotel} checked={hotel ? true : false} id="defaultCheck1" />
                        <label className="form-check-label" style={{color: 'gray'}}>
                            Hoteles
                        </label>
                    </div>
                    <div className="form-check mx-1">
                        <input className="form-check-input" type="checkbox" name="cabaña" onChange={this.handlerChangeCheckBox} value={cabaña} checked={cabaña ? true : false} id="defaultCheck1"/>
                        <label className="form-check-label" style={{color: 'gray'}}>
                            Cabañas
                        </label>
                    </div>
                    <div className="form-check mx-1">
                        <input className="form-check-input" type="checkbox" name="domicilio" onChange={this.handlerChangeCheckBox} value={domicilio} checked={domicilio ? true : false} id="defaultCheck1"/>
                        <label className="form-check-label" style={{color: 'gray'}}>
                            Domicilios
                        </label>
                    </div>
                    <div className="form-check mx-1">
                        <input className="form-check-input" type="checkbox" name="viaje" onChange={this.handlerChangeCheckBox} value={viaje} checked={viaje ? true : false} id="defaultCheck1"/>
                        <label className="form-check-label" style={{color: 'gray'}}>
                            Viajes
                        </label>
                    </div>
                ...
                <textarea name="aboutme" style={{background: 'transparent', borderColor: 'gray'}} onChange={this.handlerChange} value={aboutme} className="form-control" rows="10" cols="40">Escribe sobre ti y tus servicio</textarea>
                ...
                <select name="transporte" className="custom-select" name="sexo" style={{background: 'transparent', borderColor: 'gray'}}>
                    <option selected>Selecionar...</option>
